...
import com.dongh.funplus.http.interceptor.LoggingInterceptor;
import com.dongh.funplus.http.interceptor.RewriteCacheControlInterceptor;
...
public class RetrofitManager {
    ...
    public Flowable<LoginBean> loginObservable(String username, String password) {
        return mService.login(username, password).compose(RxUtil.<LoginBean>rxSchedulerTransformer());
    }
